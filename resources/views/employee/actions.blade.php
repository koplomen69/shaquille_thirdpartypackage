    ...
    <div class="container mt-4">
        ...
        <table class="table table-bordered table-hover table-striped mb-0 bg-white datatable" id="employeeTable">
            <thead>
                ...
                <div class="d-flex">
                    <a href="/employees/${row.id}" class="btn btn-outline-dark btn-sm me-2"><i
                            class="bi-person-lines-fill"></i></a>
                    <a href="/employees/${row.id}/edit" class="btn btn-outline-dark btn-sm me-2"><i
                            class="bi-pencil-square"></i></a>
                    <div>
                        <form action="/employees/${row.id}" method="POST" style="display: inline-block;"
                            class="form-delete">
                            @csrf
                            @method('delete')
                        ...
                        <form action="/employees/${row.id}/deleteFile" method="POST" style="display: inline-block;">
                            ...
                            <button type="submit" class="btn btn-outline-dark btn-sm me-2"
                                onclick="return confirm('Are you sure you want to delete this CV file?')">Delete CV
                                File</button>
                        </form>
                    </div>
                </div>
            ...
            <tbody>
                <!-- Dynamic rows will be populated here by DataTables -->
            </tbody>
        </table>
    </div>
